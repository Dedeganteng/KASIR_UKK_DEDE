            ...
            <?php if ($level=="Admin"): ?>
              ...
              <div class="nav-item dropdown <?= $us ?><?= $m ?>">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="index.php?makanan">Data Produk</a>
                  <a class="dropdown-item" href="index.php?pelanggan">Data Pelanggan</a>
                </div>
              </div>
                      ...
                      <table class="table table-striped table-hovered">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>Ayam</td>
                            <td><img src="assets/image/makanan/27022020052639bakar.jpg" alt="makanan" style="width: 50px; height:50px;"></td>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <?php
        ...
        $no_meja = mysqli_query($kon, "SELECT * FROM tb_pelanggan WHERE status != 1");
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <select name="meja" class="form-control" required>
                  <option selected value="0">-- Pelanggan --</option>
                  <?php foreach ($no_meja as $meja) : ?>
                      <option value="<?= $meja['nama_pelanggan'] ?>"><?= $meja['nama_pelanggan'] ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <?php $i = 1;
                    ...
                    $produk = mysqli_query($kon, "SELECT * FROM tb_produk WHERE id_produk = '$pesanan[id_produk]' ");
                    $query_produk = mysqli_fetch_assoc($produk); 
                  ?>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $query_produk['nama_produk'] ?></td>
                      <td><?= $pesanan['keterangan_dorder'] ?></td>
                      <td>Rp. <?= rupiah($query_produk['harga_produk']) ?></td>
                      <td align="center"><?= $pesanan['jumlah_dorder'] ?></td>
                      <td>Rp. <?= rupiah($query_produk['harga_produk'] * $pesanan['jumlah_dorder']) ?></td>
                      <td>
