  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-6 mx-auto" style="border: 1px solid #000;">
        <h4 class="text-center mt-2"><img src="../assets/image/logo1.png" width="40" align="middle"><span class="mt-3">TEFA RPL</span></h4>
        <hr>
        <div class="row mt-3">
          <div class="col-md-6">
            <table>
              <tr style="margin-top: 20px;">
                <td><b>TANGGAL </b> </td>
                <td>: <?= date('d-m-Y h:i', $struk['tanggal_transaksi']) ?></td>
              </tr>
              <tr style="margin-top: 20px;">
                <td><b>NO ORDER </b> </td>
                <td>: <?= $struk['id_order'] ?></td>
              </tr>
            </table>
        ...
        <div class="row">
          <?php foreach ($detail_order as $do) :
            $q_produk = mysqli_query($kon, "SELECT * FROM tb_produk WHERE id_produk = '$do[id_produk]'");
            $masakan = mysqli_fetch_assoc($q_produk);
          ?>
            <div class="col-md-3"><?= $masakan['nama_produk'] ?></div>
            <div class="col-md-1"><?= $do['jumlah_dorder'] ?></div>
            <div class="col-md-4 text-right">Rp. <?= rupiah($masakan['harga_produk']) ?></div>
