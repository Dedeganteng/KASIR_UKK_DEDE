...
$jumlahmakanan = mysqli_query($kon, "SELECT COUNT(*) AS makanan FROM tb_produk ");
$makanan = mysqli_fetch_assoc($jumlahmakanan);
$jumlahpelanggan = mysqli_query($kon, "SELECT COUNT(*) AS pelanggan FROM tb_pelanggan ");
	...
	<div class="row">
		<div class="col-md-3">
			<div class="card border-primary mb-3">
		  		<div class="row">
		    		<div class="col-md-2">
		    			<i class="fa-solid fa-bag-shopping p-3 mt-2 fa-4x"></i>
