...
mysqli_query($kon, "UPDATE tb_pelanggan set status = 1 WHERE nama_pelanggan = '$meja'");

$queryTambah = "INSERT INTO tb_order VALUES('$id_order', '$meja', '$tanggal', '$tanggal2', '$user_id', 'Sedang Proses', 0)";
