...
} elseif (isset($_GET['registrasi_pelanggan'])) {
	include 'admin/registrasi_pelanggan.php';
} elseif (isset($_GET['pelanggan'])) {
	include 'admin/data_pelanggan.php';
...
} elseif (isset($_GET['ubah_pelanggan'])) {
	include 'admin/ubah_pelanggan.php';
